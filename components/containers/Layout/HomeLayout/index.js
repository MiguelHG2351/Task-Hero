  ...
  return (
    <>
      ...
      <main className="relative min-h-[calc(100vh_-_45px)] md:h-[calc(100%_-_45px)] overflow-hidden md:grid md:grid-cols-[max-content_1fr]">
        <section ref={sidenavRef} className="sidenav-project border-dark-primary border-0 border-t-primary border-t-0.5 border-solid absolute md:static bg-black/[.6] h-[calc(100vh_-_45px)] left-0 top-0 w-screen md:w-auto md:inline-block transition-transform -translate-x-[100vw] md:translate-x-0">
